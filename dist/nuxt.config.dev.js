...
var _default = {
  ...
  ** Global CSS
  */
  css: ['~/assets/css/pagination.3.3.5.css', '~/assets/css/bootstrap.min.css', '~/assets/css/swiper.min.css', '~/assets/css/aos.css', '~/assets/css/style.scss', '~/assets/layout.scss', '~/assets/main.scss', '~/assets/input.scss', '~/assets/form-style.scss', '~/assets/cart.scss', '~/assets/transition.css'],
  ...
  */
  ...
  '@nuxtjs/axios', '@nuxtjs/pwa', '@nuxtjs/toast', // Doc: https://github.com/nuxt-community/dotenv-module
