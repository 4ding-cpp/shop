...
/**
 * repeated Commodity commodity = 7;
...
proto.ding4.Car.prototype.getCommodityList = function() {
  return /** @type{!Array<!proto.ding4.Commodity>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.ding4.Commodity, 7));
};
...
proto.ding4.Car.prototype.addCommodity = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 7, opt_value, proto.ding4.Commodity, opt_index);
};
...
proto.ding4.Car.prototype.getActivityList = function() {
  return /** @type{!Array<!proto.ding4.Activity>} */ (
    jspb.Message.getRepeatedWrapperField(this, activity$coupon_pb.Activity, 8));
};
...
proto.ding4.Car.prototype.addActivity = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 8, opt_value, proto.ding4.Activity, opt_index);
};
...
proto.ding4.Commodity.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    shellId: jspb.Message.getFieldWithDefault(msg, 14, 0)
  };
...
/**
 * optional int32 shell_id = 14;
 * @return {number}
 */
proto.ding4.Commodity.prototype.getShellId = function() {
 ...
 * @return {!proto.ding4.Commodity} returns this
 */
proto.ding4.Commodity.prototype.setShellId = function(value) {
