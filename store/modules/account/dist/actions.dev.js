...
var _default = {
  ...
  whoAmI: function whoAmI(context) {
    ...
    return regeneratorRuntime.async(function whoAmI$(_context3) {
      while (1) {
   ...
   * @param {*} context 
   */
  changeInfo: function changeInfo(context, _ref3) {
    var _ref3$condition, condition, app, metadata, method, req, res;

    return regeneratorRuntime.async(function changeInfo$(_context5) {
      while (1) {
   ...
   * @param {*} param1 
   */
  changePassword: function changePassword(context, _ref4) {
