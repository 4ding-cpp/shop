        ...
        <section class="row">
          ...
          <div class="col-md-10">
            ...
            <div class="row d-flex flex-column">
              ...
              <div class="d-flex">
                <button type="button" class="l-btn btn-facebook mr-2" style="width:50%">
                  FACEBOOK
                  快速註冊
                </button>
                <button type="button" class="l-btn btn-login mr-2" style="width:50%">會員登入</button>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-md-12 pl-0 float-left mb-3">
                <button
                  type="button"
                  @click="get_cvsStore()"
              ...
              <div class="col-md-10 float-left">
                <div class="row">
                  <div class="col-md-4 pr-2 mb-3">
                    <ButtonChoice :title="'AAA'" :free="true" />
                  </div>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="w-100">
                  ...
                  <label class="form-check-label check-label ml-4" for="defaultCheck1">取件人與購買人相同</label>
                </div>
              </div>
            </div>

            <div class="row mb-3 collapse list-unstyled" id="leftProdCounter2">
              ...
              <div class="col-md-10 float-left mb-3">
                ...
                />
                <div class="hint-label mt-2">*取貨通知將以此電話聯繫，請勿加入任何空格或符號，使用超商取貨請務必填寫10碼手機，如：0987654321</div>
              </div>
              <div class="col-md-2 float-left control-label">
